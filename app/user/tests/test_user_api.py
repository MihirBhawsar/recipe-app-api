...
class PublicUserApiTest(TestCase):
    ...
    def test_password_too_short_error(self):
        """Test an error is returned if passsword less than 5 chars."""
        payload = {
            "email": "test@example.com",
            "password": "test",
            "name": "Test Name",
...
class PrivateUserApiTests(TestCase):
    """Test API request that requied authentication."""
    ...
    def test_update_user_profile(self):
        """Test update the profile for the authenticated user."""
